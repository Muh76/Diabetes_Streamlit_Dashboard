...
# Header
st.markdown('<h1 class="main-header">🏥 Advanced Diabetes Readmission Prediction Dashboard</h1>', unsafe_allow_html=True)
...
if st.session_state.page == "Home":
    st.markdown('<h2 class="section-header">🎯 Welcome to the Advanced Diabetes Readmission Prediction Dashboard</h2>', unsafe_allow_html=True)
...
# Model Performance Page
    ...
    st.markdown('<h2 class="section-header">📊 Advanced Model Performance Analysis</h2>', unsafe_allow_html=True)
    ...
    with col2:
        ...
        fig.add_trace(go.Bar(
            name="Advanced Model",
            x=["Accuracy", "ROC-AUC", "Precision", "Recall", "F1-Score", "Specificity"],
...
# SHAP Analysis Page
    ...
    st.markdown('<h2 class="section-header">🔍 SHAP (SHapley Additive exPlanations) Analysis</h2>', unsafe_allow_html=True)
    
    st.markdown("### 📊 **Feature Importance Analysis**")
    
    # SHAP feature importance
    features = [
        "Number of Medications", "Time in Hospital", "Number of Diagnoses",
        "Age", "Lab Procedures", "Emergency Visits", "Primary Diagnosis",
        "Secondary Diagnosis", "Insurance Type", "Admission Type"
    ]
...
# LIME Analysis Page
    ...
    st.markdown('<h2 class="section-header">🎯 LIME (Local Interpretable Model Explanations) Analysis</h2>', unsafe_allow_html=True)
    
    st.markdown("### 📋 **Patient Case Analysis**")
    
    # Patient selection
    patient_id = st.selectbox("Select Patient ID:", [f"Patient_{i:03d}" for i in range(1, 21)])
    ...
    with col1:
        ...
        patient_data = {
            "Feature": ["Age", "Gender", "Number of Medications", "Time in Hospital", 
                       "Number of Diagnoses", "Lab Procedures", "Emergency Visits"],
    ...
    lime_features = ["Number of Medications", "Time in Hospital", "Age", "Lab Procedures"]
...
# Business Impact Page
    ...
    st.markdown('<h2 class="section-header">💰 Advanced Business Impact Analysis</h2>', unsafe_allow_html=True)
    ...
    with col1:
        ...
        financial_data = {
            "Metric": ["Annual Cost Savings", "Quality Bonus", "Penalty Avoidance", 
                      "Reduced Readmissions", "Improved Efficiency", "Total Impact"],
    ...
    cost_benefit_data = {
        "Category": ["Implementation Costs", "Ongoing Maintenance", "Staff Training", 
                    "System Integration", "Total Costs", "Annual Savings", "Net Benefit"],
        "Amount": ["-$500K", "-$100K", "-$50K", "-$75K", "-$725K", "+$3.2M", "+$2.475M"]
    }
...
# Technical Analysis Page
    ...
    st.markdown('<h2 class="section-header">⚙️ Technical Model Analysis</h2>', unsafe_allow_html=True)
    ...
    with col1:
        ...
        architecture_data = {
            "Component": ["Input Layer", "Hidden Layer 1", "Hidden Layer 2", 
                         "Hidden Layer 3", "Output Layer", "Activation Function"],
            "Specification": ["128 features", "256 neurons", "128 neurons", 
                             "64 neurons", "1 neuron", "ReLU/Sigmoid"]
        }
    ...
    with col2:
        ...
        train_loss = [0.8 - 0.7 * np.exp(-epoch/20) + np.random.normal(0, 0.01) for epoch in epochs]
        val_loss = [0.8 - 0.65 * np.exp(-epoch/25) + np.random.normal(0, 0.015) for epoch in epochs]
    ...
    feature_engineering_data = {
        "Feature Type": ["Original Features", "Engineered Features", "Interaction Terms", 
                        "Polynomial Features", "Encoded Features", "Total Features"],
