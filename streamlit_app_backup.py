...
# Risk Analysis Page
    ...
    with col1:
        ...
        risk_data = {
            "Risk Level": ["High Risk (>70%)", "Moderate Risk (40-70%)", "Low Risk (<40%)"],
    ...
    with col2:
        ...
        risk_factors = {
            "Factor": ["Number of Medications", "Time in Hospital", "Number of Diagnoses", "Age", "Lab Procedures"],
...
# Business Impact Page
    ...
    with col1:
        ...
        financial_data = {
            "Metric": ["Annual Cost Savings", "Quality Bonus", "Penalty Avoidance", "Total Impact"],
